      ...
      <div className="content-stretch flex gap-[8px] h-full items-center justify-end relative shrink-0">
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
          <div className="bg-white border border-[#dfe1e6] border-solid box-border content-stretch flex gap-px items-center relative rounded-[10px] shrink-0 w-full">
            {/* Avatars */}
            <div className="box-border content-stretch flex h-[32px] items-center pl-[4px] pr-[8px] py-[2px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0">
            ...
            <button
              ...
              className="border border-[#dfe1e6] border-solid h-[32px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0"
            >
              <div className="box-border content-stretch flex h-[32px] items-center justify-center overflow-clip px-[8px] py-[4px] relative rounded-[inherit]">
